...
fpga -file /home/oruud/VWorkspace/selection_sort_app/_ide/bitstream/selection_sort_design_wrapper.bit
targets -set -nocase -filter {name =~"APU*"}
...
targets -set -nocase -filter {name =~"APU*"}
source /home/oruud/VWorkspace/selection_sort_app/_ide/psinit/ps7_init.tcl
ps7_init
ps7_post_config
targets -set -nocase -filter {name =~ "*A9*#0"}
dow /home/oruud/VWorkspace/selection_sort_app/Debug/selection_sort_app.elf
